...
"    color: #607cff; /* Set the text color to a dark shade of gray */\n"
"    padding: 3px; /* Add some padding around the text */\n"
"    background-color: #0000000; /* Set the background color to white */\n"
"}\n"
"QLabel#internet_text{\n"
"	font-size: 12px;\n"
"	font-weight: bold;\n"
...
"}"));
        ...
        internet_widget->setMinimumSize(QSize(130, 35));
        ...
        internet_text->setMinimumSize(QSize(115, 0));
